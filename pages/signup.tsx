...
export default function SignupPage() {
  ...
  const handleAppleSignup = async () => {
    ...
    try {
      ...
      setError('An unexpected error occurred with Apple signup')
    } finally {
  ...
  return (
    <>
      <Head>
        <title>Create Account - GlowBoost Studio</title>
        <meta name="description" content="Create your GlowBoost Studio account" />
      </Head>
        ...
        <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden">
          ...
          <div className="relative z-20 flex flex-col justify-center px-12 text-white">
            ...
            <h1 className="text-4xl md:text-5xl font-bold leading-tight mb-6 drop-shadow-lg">
              ...
              <span className="text-yellow-300 drop-shadow-lg">beauty empire</span><br />
              today
            </h1>
            
            <p className="text-lg text-white/95 leading-relaxed max-w-lg drop-shadow-md">
              Join thousands of beauty professionals who trust GlowBoost Studio to create stunning websites, videos, and marketing materials that convert.
            </p>
          ...
          <div className="w-full max-w-md">
            ...
            <div className="text-center mt-6">
              <p className="text-xs text-gray-500">
                ...
                <Link href="/terms" className="text-blue-600 hover:text-purple-600">Terms of Service</Link>
                {' '}and{' '}
                <Link href="/privacy" className="text-blue-600 hover:text-purple-600">Privacy Policy</Link>
              </p>
            </div>
          </div>
        </div>
